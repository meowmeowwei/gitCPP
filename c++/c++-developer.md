...
* Knowledge of [TCP](https://app.gitbook.com/@sun-wei-9/s/workspace/~/drafts/-M7vGWnikov6cklOzYCp/networking/tcp-ip/tcp)/[IP](https://en.wikipedia.org/wiki/Internet_Protocol), UDP, and [network topology](https://en.wikipedia.org/wiki/Network_topology); experience with socket programming
