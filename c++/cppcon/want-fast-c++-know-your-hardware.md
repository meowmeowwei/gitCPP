...
false sharing -&gt; although variables dont interfere with each other , but they are accessed and placed in same cache line... so the same cache line is invalidated 
